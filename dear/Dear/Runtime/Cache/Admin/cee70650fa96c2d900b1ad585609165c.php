...
<body>
          ...
          <div style="display: flex;">
            <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                <input type="text" name="varieties" required lay-verify="required" placeholder="请输入品种" autocomplete="off" class="layui-input varieties">
              </div>
            </div>
            <div class="layui-form-item">
              <label class="layui-form-label">电话</label>
              <div class="layui-input-inline">
                <input type="text" name="tel" required lay-verify="required" placeholder="请输入电话" autocomplete="off" class="layui-input tel">
              </div>
            </div>
          </div>
  ...
  <script>
    $('.submit').click(function(e){
        ...
        $.ajax({
            type: "POST",
            url: "http://localhost/dear/admin/Add1/add",
            data: {
                title:title,
                varieties:varieties,
                tel:tel,
