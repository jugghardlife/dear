    ...
    <div>
      <div style="margin-top: 6vh;margin-left: 10vw;border: 1px solid #c2c2c2;padding: 40px 10px;height: 100vh;width: 70vw;border-radius: 5px;">
          <div class="layui-form-item" style="width: 60vw;">
            <label class="layui-form-label">单行输入框4</label>
          ...
          <div style="display: flex;">
            <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                <input type="text" name="text" required lay-verify="required" placeholder="请输入品种" autocomplete="off" class="layui-input varieties">
              </div>
            </div>
            <div class="layui-form-item">
              <label class="layui-form-label">电话</label>
              <div class="layui-input-inline">
                <input type="text" name="text" required lay-verify="required" placeholder="请输入电话" autocomplete="off" class="layui-input tel">
              </div>
            </div>
          </div>
  ...
  <script type="text/javascript">
    ...
    <script>
        $('.submit').click(function(e){
            ...
            $.ajax({
                type: "POST",
                url: "http://localhost/dear/admin/Add4/add",
                data: {
                    title:title,
                    varieties:varieties,
                    tel:tel,
